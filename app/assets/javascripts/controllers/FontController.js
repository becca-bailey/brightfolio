...
function get(fontKey) {
  $.ajax({
    ...
    // need select box that works with Materialize
...
// 1. parse the google data font: need to go through and create a drop down
...
$(this).addClass(".serif");
$(this).addClass(".sans-serif");
$(this).addClass(".display");
$(this).addClass(".handwriting");
